...
const R_report = require('./report')
const R_update = require('./update')
...
exports.init = function (src, dest, done) {
    ...
    if (!R_fs.existsSync(src)) {
        R_logger.fatal('invalid template: ', R_config.templatePath)
    }
...
exports.updateAndInit = function (src, dest, done) {
    R_update.update(null, function () {
        exports.init(src, dest, done)
    })
}
